...
export function JsPromisesExercise({ parameterToEffect }) {
  ...
  useEffect(() => {
    ...
    // two possible options in useEffect array of dependencies to kick useEffect and cause rerender of the component
  ...
  function logPromiseState(promise) {
    promise
      ...
      .finally(() => {
        //niezależnie od powyższych wykonam jeszcze to
